    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-5xl text0white text-gradient py-1">
            Envie Criptomoedas
            <br /> pelo mundo
          </h1>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base mb-2">
            Explore o mundo de criptomoedas, compre e venda facilmente no
            fullCrypto
          </p>
          {!currentAccount && ( 
          <button
          ...
          <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
            <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glasmorphism">
              ...
              <div className="p-5 sm:w-96 flex w-full flex-col justify-start items-center blue-glassmorphism">
                <Input
